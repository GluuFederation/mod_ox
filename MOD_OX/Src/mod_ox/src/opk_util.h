...
namespace opkele {
	 ...
	 * @return encoded data
	 */
	int	encode_base64(const unsigned char *in, long isize, unsigned char **out, long *osize);
	/**
	 * Decode binary data from base64 representation.
	 * @param data base64-encoded data
	 * @param rv container for decoded binary
	 */
	int	decode_base64(const unsigned char *in, long isize, unsigned char **out, long *osize, long max_size);
