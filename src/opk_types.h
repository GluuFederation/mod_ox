...
namespace opkele {
     ...
     */
	//typedef void assoc_t;
	typedef association_t*  assoc_t;
	...
	public:
	    ...
	    virtual void set_field(const string& n,const string& v) = 0;
	    virtual void reset_field(const string& n) = 0;
	...
	public:
	    ...
	    bool has_ns(const string& uri) const;
